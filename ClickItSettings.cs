...
namespace ClickIt
{
    public class ClickItSettings : ISettings
    {
        ...
        [Menu("Inventory Open Delay", "Milliseconds to wait after opening the inventory, must be above 200ms as the game takes a short time to open and load the window,\ndisabling clicks during that period.\n\nThis process may take longer if you're running the game on older hardware or on a HDD, which is the reason for the slider.", 9, 3000)]
