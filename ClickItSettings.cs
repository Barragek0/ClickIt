...
namespace ClickIt
{
    public class ClickItSettings : ISettings
    {
        ...
        [Menu("League Mechanic 'Chests'", "Click league mechanic related 'chests' (blight pustules, legion war hoards / chests, sentinel caches, etc)", 4, 3000)]
        ...
        [Menu("Corrupt Essences", "Corrupt essences automatically (misery, envy, dread, scorn).\n\nAlso corrupts certain essences that result in a profit when corrupted to deafening.", 10, 3000)]
        ...
        [Menu("Ignore Unique Items", "Ignore unique items, aside from metamorph organs", 12, 3000)]
