...
namespace ClickIt
{
    ...
    namespace Core.Compatibility
    {
        ...
        {
            private List<Features.Altars.PrimaryAltarComponent> _altarComponents = new List<Features.Altars.PrimaryAltarComponent>();
            private Dictionary<string, string> _textCleanCache = new Dictionary<string, string>();

            public bool AddAltarComponent(Features.Altars.PrimaryAltarComponent primary)
            {
            ...
            public IList<Features.Altars.PrimaryAltarComponent> GetAltarComponentsReadOnly() => _altarComponents.AsReadOnly();

            private static string BuildAltarKey(Features.Altars.PrimaryAltarComponent primary)
            {
