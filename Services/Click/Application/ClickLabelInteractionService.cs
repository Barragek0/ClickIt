...
namespace ClickIt.Services.Click.Application
{
    ...
    internal sealed class ClickLabelInteractionService(ClickLabelInteractionServiceDependencies dependencies)
    {
        ...
        {
            if (_dependencies.Settings.ClickEssences && _dependencies.LabelFilterService.ShouldCorruptEssence(label))
            {
        ...
        internal string BuildNoLabelDebugSummary(IReadOnlyList<LabelOnGround>? allLabels)
        {
            ...
            var summary = _dependencies.LabelFilterService.GetSelectionDebugSummary(allLabels, 0, labelCount);
        ...
        internal string BuildLabelRangeRejectionDebugSummary(IReadOnlyList<LabelOnGround>? allLabels, int start, int endExclusive, int examined)
        {
            ...
            var summary = _dependencies.LabelFilterService.GetSelectionDebugSummary(allLabels, start, maxCount);
