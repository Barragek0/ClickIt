...
{
    internal readonly record struct VisibleMechanicTargetSelectorDependencies(
    ...
    internal sealed class VisibleMechanicTargetSelector(VisibleMechanicTargetSelectorDependencies dependencies)
    {
        private readonly VisibleMechanicTargetSelectorDependencies _dependencies = dependencies;
        ...
        internal SettlersOreCandidate? ResolveNextSettlersOreCandidate()
        {
            ...
            try
            {
                ...
                IReadOnlySet<long>? labelEntityAddresses = _dependencies.CollectGroundLabelEntityAddresses();
