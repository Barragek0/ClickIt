...
namespace ClickIt.Services.Click.Selection
{
    ...
    internal sealed class OffscreenMechanicTargetSelector(OffscreenMechanicTargetSelectorDependencies dependencies)
    {
        ...
        internal Entity? ResolveNearestOffscreenWalkTarget()
        {
            ...
            _ = MechanicCandidateResolver.TryPromoteOffscreenCandidate(ref best, ref bestMechanicId, ref bestRank, ref hasBest, shrineTarget, ClickService.ShrineMechanicId, _dependencies.BuildMechanicRank);
        ...
        private Entity? ResolveNearestOffscreenShrineTarget(int maxDistance)
        {
            ...
            return ResolveNearestOffscreenEntityTarget(
                ...
                resolveMechanicId: (_, _) => ClickService.ShrineMechanicId).Target;
        }
