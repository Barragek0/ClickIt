...
namespace ClickIt.Services.Label.Application
{
        ...
        LabelMechanicResolutionService mechanicResolutionService)
    {
        ...
        public LabelFilterService.SelectionDebugSummary GetSelectionDebugSummary(IReadOnlyList<LabelOnGround>? allLabels, int startIndex, int maxCount)
        {
            ...
            return new LabelFilterService.SelectionDebugSummary(
                start,
                end,
                total,
                nullLabel,
        ...
        public void LogSelectionDiagnostics(IReadOnlyList<LabelOnGround>? allLabels, int startIndex, int maxCount)
        {
            ...
            ClickSettings clickSettings = _createClickSettings(allLabels);
            LabelFilterService.SelectionDebugSummary summary = GetSelectionDebugSummary(allLabels, start, end - start);
            string msg =
