namespace ClickIt
{
    public partial class ClickItSettings
    {
        ...
        // Persisted so the first-run performance confirmation only shows once; hidden from the legacy tree because the custom performance panel owns its rendering.
        [IgnoreMenu]
