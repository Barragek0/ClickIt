...
internal static class GlobalUsingFileBuilder
{
    ...
    private static readonly IReadOnlyDictionary<string, string> TypeAliasOverrides = new Dictionary<string, string>(StringComparer.Ordinal)
    {
        ...
        ["ChestLootSettlementTiming"] = "ClickIt.Features.Click.Runtime.ChestLootSettlementTiming",
        ["ChestLootSettlementTimingOptions"] = "ClickIt.Features.Click.Runtime.ChestLootSettlementTimingOptions",
