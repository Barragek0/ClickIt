...
{
    // Level 4 is every tower's specialization tier (BlightTowerData.MaxUpgradeLevel) — an upgrade step ending at 4 is the 3->4 SPEC action, not a plain rank upgrade.
