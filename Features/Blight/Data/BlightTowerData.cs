...
internal static class BlightTowerData
{
    ...
    [
        ...
        new(BlightTowerId.FlyingMinionTower, "FlyingMinionTower", "Scout Tower", 75, BlightTowerType.Summoning, TowerSpecialization.ScoutMinion, 0),
        new(BlightTowerId.TankyMinionTower, "TankyMinionTower", "Sentinel Tower", 45, BlightTowerType.Summoning, TowerSpecialization.TankMinion, 1),
