...
{
    /// <summary>
    /// Debug-only overlay: draws the AreaService UI-region rectangles (blocked screen regions)
    /// every frame via the ImGui foreground draw list, gated only by its debug setting.
    /// </summary>
