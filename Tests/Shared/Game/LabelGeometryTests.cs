namespace ClickIt.Tests.Shared.Game
{
    ...
    public class LabelGeometryTests
    {
        ...
        [TestMethod]
        public void SortByDistance_SortsByPrecomputedDistances()
        {
            ...
            LabelGeometry.SortByDistance(labels, ReadDistance);

            labels.Should().ContainInOrder(near, mid, far);
        }

        [TestMethod]
        public void SortByDistance_UsesQuickSortPath_ForLargeLabelLists()
        {
