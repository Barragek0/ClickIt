...
namespace ClickIt.Tests.Rendering
{
    ...
    public class DebugRendererLogicTests
    {
        ...
        public void BuildClickSettingsDebugSnapshotLines_ReturnsExpectedStructuredLines()
        {
            ...
            var lines = global::ClickIt.Rendering.DebugRenderer.BuildClickSettingsDebugSnapshotLines(settings);
        ...
        {
            var metrics = global::ClickIt.Rendering.DebugRenderer.BuildClickFrequencyTargetDebugMetrics(
                clickTargetMs: 100,
                processingMs: 30,
