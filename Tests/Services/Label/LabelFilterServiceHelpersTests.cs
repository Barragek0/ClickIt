...
namespace ClickIt.Tests.Unit
{
    ...
    public class LabelFilterServiceHelpersTests
    {
        ...
        {
            var res1 = InvokePrivateStatic<string?>("GetChestMechanicIdInternal", true, true, true, true, true, true, true, true, true, ExileCore.Shared.Enums.EntityType.Monster, "some/path", "chest");
            res1.Should().BeNull();

            var res2 = InvokePrivateStatic<string?>("GetChestMechanicIdInternal", true, false, true, true, true, true, true, true, true, ExileCore.Shared.Enums.EntityType.Chest, null, "Chest");
            res2.Should().Be("basic-chests");

            var res3 = InvokePrivateStatic<string?>("GetChestMechanicIdInternal", false, true, true, true, true, true, true, true, true, ExileCore.Shared.Enums.EntityType.Chest, null, "Some League");
            res3.Should().Be("league-chests");

            var res4 = InvokePrivateStatic<string?>("GetChestMechanicIdInternal", true, true, true, true, true, true, true, true, true, ExileCore.Shared.Enums.EntityType.Chest, "StrongBoxes/Strongbox", "strongbox");
            res4.Should().BeNull();

            var mirageDisabled = InvokePrivateStatic<string?>("GetChestMechanicIdInternal", false, true, false, false, false, false, false, true, true, ExileCore.Shared.Enums.EntityType.Chest, null, "Golden Djinn's Cache");
            mirageDisabled.Should().BeNull();

            var mirageEnabled = InvokePrivateStatic<string?>("GetChestMechanicIdInternal", false, true, false, true, false, false, false, true, true, ExileCore.Shared.Enums.EntityType.Chest, null, "Golden Djinn's Cache");
            mirageEnabled.Should().Be("league-chests");

            var heistDisabled = InvokePrivateStatic<string?>("GetChestMechanicIdInternal", false, true, false, true, true, true, false, true, true, ExileCore.Shared.Enums.EntityType.Chest, null, "Secure Locker");
            heistDisabled.Should().BeNull();

            var heistEnabled = InvokePrivateStatic<string?>("GetChestMechanicIdInternal", false, true, false, true, true, true, true, true, true, ExileCore.Shared.Enums.EntityType.Chest, null, "Secure Locker");
            heistEnabled.Should().Be("league-chests");

            const string breachGraspingCoffersPath = "Metadata/Chests/Breach/BreachBoxChest02";
            var breachDisabled = InvokePrivateStatic<string?>("GetChestMechanicIdInternal", false, true, false, true, true, true, true, false, true, ExileCore.Shared.Enums.EntityType.Chest, breachGraspingCoffersPath, "Grasping Coffers");
            breachDisabled.Should().BeNull();

            var breachEnabled = InvokePrivateStatic<string?>("GetChestMechanicIdInternal", false, true, false, true, true, true, true, true, true, ExileCore.Shared.Enums.EntityType.Chest, breachGraspingCoffersPath, "Grasping Coffers");
            breachEnabled.Should().Be("league-chests");

            const string synthesisStashPath = "Metadata/Chests/SynthesisChests/SynthesisChest";
            var synthesisDisabled = InvokePrivateStatic<string?>("GetChestMechanicIdInternal", false, true, false, true, true, true, true, true, false, ExileCore.Shared.Enums.EntityType.Chest, synthesisStashPath, "Synthesised Stash");
            synthesisDisabled.Should().BeNull();

            var synthesisEnabled = InvokePrivateStatic<string?>("GetChestMechanicIdInternal", false, true, false, true, true, true, true, true, true, ExileCore.Shared.Enums.EntityType.Chest, synthesisStashPath, "Synthesised Stash");
