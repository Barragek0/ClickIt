...
public class BlightMenuInteractionsTests
{
    ...
    {
        // The walk-ready region must use the step's OWN icon: an unbuilt foundation has no upgrade
        // button (Child[3]), so checking it for a BUILD step never resolves and stalls the build.
