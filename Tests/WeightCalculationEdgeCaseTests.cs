...
namespace ClickIt.Tests
{
    ...
    public class WeightCalculationEdgeCaseTests
    {
        ...
        public void WeightCalculation_ShouldHandleUnknownMods()
        {
            ...
            // Assert
            upsideResult.Should().Be(1m, "unknown upside mods should default to weight 1");
            downsideResult.Should().Be(2m, "unknown downside mods should be 1 base + 1 default = 2");
        }
